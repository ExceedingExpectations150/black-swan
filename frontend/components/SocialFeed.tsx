...
import { Globe, Heart, Repeat2, X } from "lucide-react";
    ...
    <div className="panel flex h-full flex-col">
      <div className="flex items-center justify-between border-b border-hair px-3 py-2.5">
        <div className="flex items-center gap-2">
          <span className="section-title">Social Feed</span>
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex flex-wrap items-baseline gap-x-1.5 text-[11px]">
          <span className="font-semibold text-ink">{post.author_display}</span>
